...
public class Project extends JFrame implements ActionListener {
    Project(){
        ...
        JMenuItem m1=new JMenuItem("Faculty");
...
JMenu ut1=new JMenu("NotePad");
JMenu ut2=new JMenu("Calculator");
JMenu ut3=new JMenu("Web Browser");
...
ut1.setFont(new Font("monospaced",Font.BOLD,16));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Addmission")){
            ...
            try{
                Runtime.getRuntime().exec("NotePade.exec");
            }catch(Exception e){}
        }
